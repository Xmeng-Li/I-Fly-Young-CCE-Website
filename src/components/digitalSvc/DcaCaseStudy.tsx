...
import "../../styles/dcaCase.css";

import topImg from "./dca-mockup.png";
import logo from "./DCA Logo_white footer.png";
import home from "./dca-Home.png";
import about from "./dca-About.png";
import program from "./dca-Programs.png";
import enroll from "./dca-Enrollment.png";
import event from "./dca-Events.png";
import career from "./dca-Careers.png";
import contact from "./dca-Contact.png";
import mobile from "./dca-mobile.jpg";
...
const DcaCase = () => {
  ...
  const caseContent: Content[] = t("contents", { ns: "dca", returnObjects: true });
  ...
  useEffect(() => {
    document.body.style.backgroundColor = "#FDF4E2";
    return () => {
  ...
  return (
    <div>
      <Header />
      <div className="dcaCase-backTo">
        <Link to="/digital-service" className="left-arrow">
          <LeftArrow />
        </Link>
        <label className="dcaCase-backTo-text">{t("backToSol")}</label>
      </div>
      <div className="dcaCase-banner">
        <div className="dcaCase-left-content">
          <span className="dcaCase-sub">{t("caseSub")}</span>
          <span className="dcaCase-title">{t("caseTitle")}</span>
          <img className="dca-logo" src={logo} alt="logo" />
        </div>
        <img className="dca-mockUp" src={topImg} alt="mockup" />
      </div>

      {/* Our Work */}
      <div className="dca-top-three">
        <label className="dca-work-label">{caseContent[0].works}</label>
        <label className="dca-work-sub">{caseContent[0].workSub}</label>
        <div className="dca-work-three">
          <div className="dca-work-part">
            <span className="dca-top-three-icons"><FaceIcon /></span>
            <div
              className="dca-work-text"
              dangerouslySetInnerHTML={{ __html: caseContent[0].leftText }}
            />
          </div>
          <div className="dca-work-part">
            <span className="dca-top-three-icons"><StarIcon /></span>
            <div className="dca-work-text">{caseContent[0].midText}</div>
          </div>
          <div className="dca-work-part">
            <span className="dca-top-three-icons"><LabtopIcon /></span>
            <div
              className="dca-work-text"
      ...
      {/* Main */}
      <div className="dca-section-wrap">
        {/* Outcomes */}
        <div className="sec-detail">
          <div className="dca-outcomes-wrap">
            <label className="dca-work-label">
              {caseContent[1].secTitle1}
            </label>
            <ul className="dca-lst">
          ...
          <div className="dca-comp-wrap">
            {/* Webpage */}
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].home}</span>
              <img
                className="dca-site-img"
                src={home}
                alt="Home preview"
                onClick={() => setPreviewImg(home)}
              />
            </div>
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].about}</span>
              <img
                className="dca-site-img"
                src={about}
                alt="About preview"
                onClick={() => setPreviewImg(about)}
              />
            </div>
          </div>
          <div className="dca-comp-wrap">
            {/* Webpage */}
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].prog}</span>
              <img
                className="dca-site-img"
                src={program}
                alt="Program preview"
                onClick={() => setPreviewImg(program)}
              />
            </div>
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].enrol}</span>
              <img
                className="dca-site-img"
                src={enroll}
                alt="Enrollment preview"
                onClick={() => setPreviewImg(enroll)}
              />
            </div>
          </div>
          <div className="dca-comp-wrap">
            {/* Webpage */}
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].event}</span>
              <img
                className="dca-site-img"
                src={event}
                alt="Event preview"
                onClick={() => setPreviewImg(event)}
              />
            </div>
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].career}</span>
              <img
                className="dca-site-img"
                src={career}
                alt="Career preview"
                onClick={() => setPreviewImg(career)}
              />
            </div>
          </div>
          <div className="dca-comp-wrap">
            {/* Webpage */}
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].contact}</span>
              <img
                className="dca-site-img"
                src={contact}
                alt="Contact preview"
                onClick={() => setPreviewImg(contact)}
              />
            </div>
            <div className="dca-comp">
              <span className="dca-comp-label">{caseContent[1].mobile}</span>
              <img
                className="dca-site-img"
                src={mobile}
                alt="Mobile preview"
                onClick={() => setPreviewImg(mobile)}
              />
            </div>
          </div>
        </div>
      ...
      <div className="dca-btm">
        <div className="dca-btm-header">
          <label className="dca-btm-title">
            {t("svcBtmTitle")}
          </label>
          <span className="dca-btm-circle"><Circle /></span>
        </div>
        <div className="dca-btm-texts">{t("svcBtmTexts")}</div>
        <button className="dca-btm-btn">
      ...
      {previewImg && (
        <div className="dca-lightbox" onClick={() => setPreviewImg(null)}>
          <img
            className={`dca-lightbox-img ${zoomed ? "zoomed" : ""}`}
            src={previewImg}
            alt="Full preview"
            onClick={(e) => {
              e.stopPropagation();
