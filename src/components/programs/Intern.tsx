...
const Intern = () => {
  ...
  const mainContent: internContents[] = t("projContents", { ns: "programs", returnObjects: true });
  ...
  return (
    <div>
      <Header />
      <div className="intern-backTo">
        <Link to="/programs">
          <div className="left-arrow">
            <LeftArrow />
          </div>
        </Link>
        <label className="intern-backTo-text">{t("backToText")}</label>
      </div>
      <div className="intern-top-part">
        <div className="intern-left-content">
          <span className="internTitle">{t("projTitle")}</span>
          <button className="intern-apply-btn"> {/* form need to be updated */}
        ...
        <img className="intern-top-img" src={projTopImg} alt="topImg" />
      </div>
      ...
      <div className="intern-content-container">
        ...
        <div className="intern-main-top">
          <label className="intern-section-label">{mainContent[0].overview}</label>
          <img className="intern-top-bk" src={projTopBk} alt="top background" />
          <div className="intern-top-three">
      ...
      {/* Bottom Part */}
      <div className="intern-bottom-part">
        <img className="intern-btm-img" src={projBtmImg} alt="btmImg" />
        <div className="intern-right-content">
          <span className="intern-btm-title">{t("projBtmTitle")}</span>
          <button className="intern-apply-btn">{/* form need to be updated */}
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdpSAC9LCf8O73iJss12DqnA3AHWjdhZQ9QFA7qfkGPlA8OoQ/viewform" target="_blank" rel="noopener noreferrer">
              {t("applyNow")}
            </a>
