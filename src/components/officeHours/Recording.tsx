  ...
  render() {
    ...
    const FilterIcon = () => (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
        <mask id="mask0_1670_10806" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="25">
          <rect y="0.845703" width="24" height="24" fill="#D9D9D9"/>
        </mask>
        <g mask="url(#mask0_1670_10806)">
          <path d="M11.0011 20.8457C10.7177 20.8457 10.4802 20.7499 10.2886 20.5582C10.0969 20.3665 10.0011 20.129 10.0011 19.8457V13.8457L4.20106 6.4457C3.95106 6.11237 3.91356 5.76237 4.08856 5.3957C4.26356 5.02904 4.56772 4.8457 5.00106 4.8457H19.0011C19.4344 4.8457 19.7386 5.02904 19.9136 5.3957C20.0886 5.76237 20.0511 6.11237 19.8011 6.4457L14.0011 13.8457V19.8457C14.0011 20.129 13.9052 20.3665 13.7136 20.5582C13.5219 20.7499 13.2844 20.8457 13.0011 20.8457H11.0011Z" fill="#525252"/>
        </g>
      </svg>
    );
        ...
        <div className="speed-control">
          ...
          {showMenu && (
            <div className="speed-menu">
              <p className="speed-tooltip">
                {t("PlySpeed", { ns: "officehour" })}
              </p>
              {speeds.map((rate) => (
                <div
                  key={rate}
      ...
      <div className="recording-page">
        ...
        <div className="recording-container">
          {paginatedAudio.map((recording, index) => {
            ...
            const playerRef = React.createRef<H5AudioPlayer>();
            const rate = this.state.playbackRates[recording.id] ?? 1;
            const isMenuOpen = this.state.openSpeedMenuId === recording.id;
                    ...
                    <div className="player-container">
                      <AudioPlayer className="player"
                        ...
                        customAdditionalControls={[
                          <SpeedControl
                            key={`speed-${recording.id}`}
                            playerRef={playerRef}
                            playbackRate={rate}
                            showMenu={isMenuOpen}
                            onToggleMenu={() =>
                              this.setState({
                                openSpeedMenuId: isMenuOpen ? null : recording.id,
                              })
                            }
