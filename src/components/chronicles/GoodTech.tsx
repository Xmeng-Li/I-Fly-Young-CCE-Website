...
import img1 from "./hearing_aid.png";
import img2 from "./robot_hand.png";
...
const GoodTech = () => {
  ...
  const articleTexts: ArticleType[] = t("article3", { ns: "articles", returnObjects: true });
  ...
  return (
    <div>
      ...
      <div className="article-container">
        {articleTexts.map((article3, index) => (
          <div key={index} className="art-card">
            <h4 className="art-title">{article3.title}</h4>
            <div className="authors-box">
              <span className="date-and-duration">{article3.date} &#183; {article3.duration}</span>
              <span className="authors">{t("authors")}</span>
            </div>
            <div className="responder-box">
              <div className="resp-left">
                <img className="resp-square-image" src={article3.image} alt={article3.image} />
                <div className="resp-name">{article3.responder}</div>
                <div className="resp-role">{article3.role}</div>
              </div>
            ...
            <div className="art-detail">
              {article3.content.map((item, index) => (
                <div key={index}>
